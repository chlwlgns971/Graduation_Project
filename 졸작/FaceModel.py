...
#학습데이터 불러오기
groups_folder_path1 = 'C:\\Users\\LSP\\FaceRecognize\\train_dataset'
categories = ['face','nonface']
...
#테스트데이터 불러오기
groups_folder_path2 = 'C:\\Users\\LSP\\FaceRecognize\\test_dataset'
categories = ['face','nonface']
num_classes = len(categories)
...
#모델 최적화
modelpath='C:\\Users\\LSP\\FaceRecognize\\FaceModel1022.hdf5' #학습된 모델 저장경로와 이름
...
history=model.fit(X_train, Y_train, validation_data=(X_test,Y_test), batch_size=32, epochs=100, verbose=0, callbacks=[early_stopping_callback,checkpointer])
